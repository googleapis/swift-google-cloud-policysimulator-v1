...
let package = Package(
  ...
  platforms: [.macOS(.v15)],
  products: [
    .library(name: "GoogleCloudPolicySimulatorV1", targets: ["GoogleCloudPolicySimulatorV1"])
  ],
  dependencies: [
    .package(path: "../../packages/auth"),
    .package(path: "../../packages/gax"),
    .package(path: "../../generated/google-cloud-orgpolicy-v2"),
  ...
  targets: [
    .target(
      ...
      dependencies: [
        ...
        .product(name: "GoogleCloudOrgPolicyV2", package: "google-cloud-orgpolicy-v2"),
