  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let orgPolicyViolationsPreviews = CodingKeys(stringValue: "orgPolicyViolationsPreviews")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [OrgPolicyViolationsPreview].self, forKey: .orgPolicyViolationsPreviews)
    {
      self.orgPolicyViolationsPreviews = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.orgPolicyViolationsPreviews, forKey: .orgPolicyViolationsPreviews)
