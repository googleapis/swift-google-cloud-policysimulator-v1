...
extension Clients {
  ...
  class OrgPolicyViolationsPreviewServiceTransport: OrgPolicyViolationsPreviewServiceStub {
    let inner: GoogleCloudGax.HTTPClient

    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax.HTTPClient(
        from: options, withDefaultEndpoint: "https://policysimulator.googleapis.com")
    }
    ...
    public func listOrgPolicyViolationsPreviews(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/orgPolicyViolationsPreviews"
      }()
      var query = [
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudPolicySimulatorV1.ListOrgPolicyViolationsPreviewsResponse.self, from: data)
    }
    ...
    public func getOrgPolicyViolationsPreview(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudPolicySimulatorV1.OrgPolicyViolationsPreview.self, from: data)
    }
    ...
    public func listOrgPolicyViolations(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/orgPolicyViolations"
      }()
      var query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudPolicySimulatorV1.ListOrgPolicyViolationsResponse.self, from: data)
    }
