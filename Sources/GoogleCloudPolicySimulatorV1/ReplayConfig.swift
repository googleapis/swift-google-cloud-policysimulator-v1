...
public struct ReplayConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var policyOverlay: [Swift.String: GoogleIAMV1.Policy] = [:]
  ...
  ///
  /// ```
  /// let value = ReplayConfig().with { $0.policyOverlay = ... }
  /// ```
  ...
  public enum LogSource: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      ...
      case .recentAccesses: return "RECENT_ACCESSES"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "RECENT_ACCESSES": self = .recentAccesses
