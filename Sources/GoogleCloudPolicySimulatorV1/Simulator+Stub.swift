...
extension Clients {
  ...
  class SimulatorTransport: SimulatorStub {
    ...
    public func getReplay(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudPolicySimulatorV1.Replay.self, from: data)
    }
    ...
    public func createReplay(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/replays"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
    ...
    public func listReplayResults(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudPolicySimulatorV1.ListReplayResultsResponse.self, from: data)
    }
