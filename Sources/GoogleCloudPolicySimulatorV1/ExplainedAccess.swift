...
/// [google.cloud.policysimulator.v1.ExplainedPolicy]: <doc:ExplainedPolicy>
public struct ExplainedAccess: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// Whether the principal in the access tuple has permission to access the
  /// resource in the access tuple under the given policies.
  public var accessState: AccessState = AccessState()
  ...
  ///
  /// [google.cloud.policysimulator.v1.AccessState]: <doc:AccessState>
  public var policies: [ExplainedPolicy] = []
  ...
  /// Initialize a new instance of `ExplainedAccess`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ExplainedAccess().with { $0.accessState = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let accessState = CodingKeys(stringValue: "accessState")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(AccessState.self, forKey: .accessState) {
      self.accessState = value
    }
    if let value = try container.decodeIfPresent([ExplainedPolicy].self, forKey: .policies) {
      self.policies = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.accessState, forKey: .accessState)
